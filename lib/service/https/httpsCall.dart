...
//  Future<void> fetchPincodeInfo(String pincode) async {
//     final response = await http.get('https://api.postalpincode.in/pincode/$pincode');
...
//     } else {
//       throw Exception('Failed to fetch pincode info');
//     }
//   }
